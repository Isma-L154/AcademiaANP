...
{
    /// <inheritdoc />
    public partial class TipoDatosTablaNotificaciones : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdRecurso = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notificaciones_Users_IdUser",
                        column: x => x.IdUser,
